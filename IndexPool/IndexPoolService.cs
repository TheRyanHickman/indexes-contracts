...
using IndexesContracts.Contracts.IndexPool.ContractDefinition;

namespace IndexesContracts.Contracts.IndexPool
{
    public partial class IndexPoolService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, IndexPoolDeployment indexPoolDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<IndexPoolDeployment>().SendRequestAndWaitForReceiptAsync(indexPoolDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, IndexPoolDeployment indexPoolDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<IndexPoolDeployment>().SendRequestAsync(indexPoolDeployment);
        }

        public static async Task<IndexPoolService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, IndexPoolDeployment indexPoolDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, indexPoolDeployment, cancellationTokenSource);
            return new IndexPoolService(web3, receipt.ContractAddress);
        }
        ...
        public IndexPoolService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
        ...
        public Task<BigInteger> GetPoolPriceBUSDQueryAsync(GetPoolPriceBUSDFunction getPoolPriceBUSDFunction, BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<GetPoolPriceBUSDFunction, BigInteger>(getPoolPriceBUSDFunction, blockParameter);
        }

        
        public Task<BigInteger> GetPoolPriceBUSDQueryAsync(BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<GetPoolPriceBUSDFunction, BigInteger>(null, blockParameter);
        }

        public Task<BigInteger> GetTokenPriceBUSDQueryAsync(GetTokenPriceBUSDFunction getTokenPriceBUSDFunction, BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<GetTokenPriceBUSDFunction, BigInteger>(getTokenPriceBUSDFunction, blockParameter);
        }

        
        public Task<BigInteger> GetTokenPriceBUSDQueryAsync(string token, BlockParameter blockParameter = null)
        {
            var getTokenPriceBUSDFunction = new GetTokenPriceBUSDFunction();
                getTokenPriceBUSDFunction.Token = token;
        ...
        public Task<string> MintRequestAsync(BigInteger bUSDIn, BigInteger minAmountOut)
        {
            var mintFunction = new MintFunction();
                mintFunction.BUSDIn = bUSDIn;
                mintFunction.MinAmountOut = minAmountOut;
            
             return ContractHandler.SendRequestAsync(mintFunction);
        }

        public Task<TransactionReceipt> MintRequestAndWaitForReceiptAsync(BigInteger bUSDIn, BigInteger minAmountOut, CancellationTokenSource cancellationToken = null)
        {
            var mintFunction = new MintFunction();
                mintFunction.BUSDIn = bUSDIn;
                mintFunction.MinAmountOut = minAmountOut;
